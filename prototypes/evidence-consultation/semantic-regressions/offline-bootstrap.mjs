// Start directly with env -i node .../offline-bootstrap.mjs, NOT node --test.
// node:test runs in this process; no child process is needed.
// Pattern: existing comparison offline-lockdown, copied without old-file edits.
...
// Node's built-in loader thread is initialized first; user workers are then denied.
register("./offline-loader.mjs", import.meta.url);
workers.Worker = deny;
syncBuiltinESMExports();
Object.defineProperty(globalThis, "__semanticOfflineBoundary", {
  value: Object.freeze({
